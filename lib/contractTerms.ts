/**
 * 국외여행 표준약관 (공정거래위원회 표준약관 제10021호, 2019.8.30. 개정) 전문.
 * 한국여행업협회(tourinfo.or.kr) 공식 게시 원문을 그대로 옮겼다. 조항 내용을 바꾸거나 요약하지 않는다.
 * 출처: http://www.tourinfo.or.kr/v2/info/agreement_02.asp
 */
...
export const STANDARD_CONTRACT_TERMS: ContractArticle[] = [
  {
    title: "제1조(목적)",
    body: ["이 약관은 ○○여행사와 여행자가 체결한 국외여행계약의 세부 이행 및 준수사항을 정함을 목적으로 합니다."],
  },
  {
    title: "제2조(용어의 정의)",
    body: [
  ...
  {
    title: "제12조(여행조건의 변경요건 및 요금 등의 정산)",
    body: [
  ...
  {
    title: "제20조(설명의무)",
    body: ["여행사는 계약서에 정하여져 있는 중요한 내용 및 그 변경사항을 여행자가 이해할 수 있도록 설명하여야 합니다."],
  },
  {
    title: "제21조(보험가입 등)",
    body: ["여행사는 이 여행과 관련하여 여행자에게 손해가 발생한 경우 여행자에게 보험금을 지급하기 위한 보험 또는 공제에 가입하거나 영업보증금을 예치하여야 합니다."],
  },
  {
    title: "제22조(기타사항)",
    body: [
...
export const CONTRACT_TERMS_REVISED = "2019. 8. 30. 개정";
export const CONTRACT_TERMS_SOURCE = "공정거래위원회 표준약관 제10021호 (한국여행업협회 tourinfo.or.kr 게시본)";
