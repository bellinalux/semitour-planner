...
export function buildCompetitorResearchPrompt(req: CompetitorRequest): string {
  ...
  return [
    ...
    "7. 요금을 확인한 사이트 이름",
    "8. 이 상품의 실제 판매 페이지(상세 페이지) URL. 검색 결과나 여행사 홈페이지가 아니라, 그 상품을 소개하는 정확한 페이지 주소를 그대로 적으세요. 확실하지 않으면 '확인 못함'이라고 쓰세요.",
    "",
...
- productUrl은 메모에 적힌 정확한 URL을 그대로 옮깁니다. 메모가 확인하지 못했다고 했거나 URL 형태가 아니면 빈 문자열로 둡니다. URL을 지어내지 않습니다.
