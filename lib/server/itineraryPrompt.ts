...
2. 오전(amGuided): 가이드가 동행하는 핵심 명소 2~3곳과 점심 식사 장소 1곳을 마지막 항목으로 포함합니다. 점심 식당 항목의 mealCost에 1인 예상 식대를 넣습니다. 오전 미팅(투어 시작) 시각은 보통 08:00이므로, 그 앞 명소들의 체류·이동 시간 합계를 조절해 점심 식당 항목이 11:30~12:30 사이에 시작하도록 합니다.
